...
export default async function handler(req, res) {
  ...
  // Public Jamendo "testing" client_id (works out of the box, no signup needed).
  // For your own production app, register a free client_id at
  // https://devportal.jamendo.com and set it as the JAMENDO_CLIENT_ID
